...
Next.js (Advanced) • React • TypeScript • Tailwind • PWA • Prisma • PostgreSQL / Turso • REST APIs • Real-time & offline sync
...
### [showrunner](https://github.com/taylordrew4u2/showrunner)

Live show production tool powering real comedy performances. Plan lineups, AI-import schedules from photos, run full-screen live mode with cue timers and walk-on music.

**Tech:** React 19 + TypeScript + Turso
...
### [RoleCall](https://github.com/taylordrew4u2/Role-Call)
...
### [BillBuddies](https://github.com/taylordrew4u2/BillBuddies)

Roommate bill splitting with offline sync and intelligent debt settlement.

**Tech:** Next.js 16 + React 19 + IndexedDB + Prisma
